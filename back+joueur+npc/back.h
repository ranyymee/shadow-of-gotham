...
#define ROLE_OBSTACLE 0
#define ROLE_BONUS    1
#define ROLE_ENIGME   2
...
typedef struct {
    ...
    int          moveAxis;
    int          hp;
    int          role;       /* ROLE_OBSTACLE / ROLE_BONUS / ROLE_ENIGME */
    int          collected;  /* 1 = deja ramasse, ne plus afficher */
    int          bonusValue; /* points gagnes au ramassage */
} Platform;
