...
void NPC_loadLevel(GameNPC *n, SDL_Renderer *r, int lvl) {
    ...
    int pos[3][2] = {{500, 650}, {700, 600}, {900, 650}};
    ...
    it1.type = POWERUP;
    it1.x = 300; it1.y = 700; it1.w = 30; it1.h = 30;
    ...
    if (lvl == 2) {
        ...
        it3.type = POWERUP;
        it3.x = 500; it3.y = 600; it3.w = 35; it3.h = 35;
