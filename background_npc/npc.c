...
void NPC_loadLevel(GameNPC *n, SDL_Renderer *r, int lvl) {
    ...
    int pos[3][2] = {{500,950}, {700,900}, {900,950}};
    int hpVals[3] = {80,70,100};
    ...
    for (int i = 0; i < nbEnemies; i++) {
        ...
        e.minX = e.x - 200; e.maxX = e.x + 200;
        e.minY = e.y - 150; e.maxY = e.y + 150;
        e.damage = dmgVals[i];
        e.score = ptsVals[i];
    ...
    it1.type = POWERUP;
    it1.x = 300; it1.y = 850; it1.w = 30; it1.h = 30;
    ...
    if (lvl == 2) {
        ...
        it3.type = POWERUP;
        it3.x = 500; it3.y = 700; it3.w = 35; it3.h = 35;
