...
static void renderBack(int hovered,int clicked,Uint32 ticks){
    SDL_Rect r={PUZZLE_BACK_X,PUZZLE_BACK_Y,PUZZLE_BACK_W,PUZZLE_BACK_H};
    ...
    BAT(PUZZLE_BACK_X-18,PUZZLE_BACK_Y+PUZZLE_BACK_H/2,11,0,200,60,hovered?235:115);
}
...
int run_menu(SDL_Window *win){
    ...
    SDL_Rect backRect={PUZZLE_BACK_X,PUZZLE_BACK_Y,PUZZLE_BACK_W,PUZZLE_BACK_H};
