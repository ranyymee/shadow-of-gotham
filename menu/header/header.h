#pragma once
/*
 * header.h — TACTICAL DECRYPTION ENGINE (Puzzle/Enigme module)
 * Inclus UNIQUEMENT par : mainenigme.c, puzzle.c
 *
 * IMPORTANT : NE PAS inclure dans Main.c, sourceMenu.c, sauvegarde.c, etc.
 * Pour le menu principal, utiliser game.h.
 */
...
/* ── Window (fenêtre du puzzle, différente du menu principal) ── */
#define WIN_W   1920
#define WIN_H    922
...
/* ── Puzzle selection — chemins relatifs à l'exécutable ── */
#define NUM_PUZZLES  4
extern const char *PUZZLE_IMAGES[NUM_PUZZLES];
...
/* Renommés pour éviter le conflit avec options.h (BACK_X, BACK_Y, BACK_W, BACK_H) */
#define PUZZ_BACK_X    24
#define PUZZ_BACK_Y   511
#define PUZZ_BACK_W    90
#define PUZZ_BACK_H    34

#define ACCENT    18

/* ── État du puzzle (renommé pour éviter conflit avec GameState de game.h) ── */
typedef enum { ST_PLAY, ST_WIN, ST_LOSE } PuzzleState;
...
/* ── Shared renderer + fonts (définis dans mainenigme.c) ── */
...
/* ── Point d'entrée public appelé depuis Main.c ── */
