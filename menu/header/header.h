 ...
 * FIX 1: renamed GameState -> PuzzleState  (avoids clash with game.h GameState)
 * FIX 2: renamed BACK_X/Y/W/H -> PUZZLE_BACK_X/Y/W/H (avoids clash with options.h)
 */
...
/* ─────────────────────────────────────────────────────────────────────────
   MENU LAYOUT
   FIX: renamed BACK_X/Y/W/H -> PUZZLE_BACK_X/Y/W/H
        to avoid redefinition clash with options.h BACK_X/Y/W/H
   ───────────────────────────────────────────────────────────────────────── */
#define MAIN_X        240
#define MAIN_Y         54
#define MAIN_W        596
...
#define CARD_B_X      450
#define CARD_C_X      854
#define PUZZLE_BACK_X  24
#define PUZZLE_BACK_Y 570
#define PUZZLE_BACK_W  90
#define PUZZLE_BACK_H  34
#define ACCENT         18

/* ─────────────────────────────────────────────────────────────────────────
   ENUMS
   FIX: renamed GameState -> PuzzleState
        to avoid redefinition clash with game.h GameState
   ───────────────────────────────────────────────────────────────────────── */
